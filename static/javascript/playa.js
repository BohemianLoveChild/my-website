...
var playButton = $('#playButton'),
    ...
    function onPlaying() {
        ...
        .to(poster, 1.69, {autoAlpha: "0", scale: "1.15", rotation: "-1.5", ease:Sine.easeInOut}, "0");
    }
    function onPaused() {
        ...
        .fromTo(poster, 0.55, {autoAlpha: "0", scale:"1.05", rotation:"-0.5"}, {autoAlpha: "1", scale:"1",rotation:"0",ease:Sine.easeInOut}, "0")
        .to(socialButtons,0,{display: "block"},0)
        .from(socialButtons,1, {y: "-100%", scale: "0", ease:Sine.easeOut}, "0");
